# The purpose of this python file is to find the regressional model that best fit the line haul data and
...
ltl_price['tot_mile_wt'] = ltl_price["tot_mile_cnt1"] * ltl_price["tot_shp_wt1"]
